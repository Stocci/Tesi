...
\begin{itemize}
	\item \textbf{Tutte le tecnologie eventualmente utilizzate avrebbero necessariamente essere \emph{open-source};}
	\item \textbf{Evitare il più possibile di appesantire ultieriormente il software con nuove librerie o framework, ma possibilmente riutilizzarli.}
\end{itemize}