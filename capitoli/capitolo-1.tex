...
\end{figure}
Sanmarco Informatica Spa è un'azienda italiana leader nella progettazione e realizzazione di soluzioni a supporto della riorganizzazione di tutti i processi aziendali e professionali. \\ Ha sede a  Grisignano di Zocco (VI), è attiva da 35 anni e può contare su più di 400 dipendenti e collaboratori per seguire quotidianamente più di 1000 aziende clienti. \\ 
...
Qui viene adottato il metodo di lavoro \emph{Agile}: esso nasce nel 2001 e definisce i dodici principi fondamentali per sviluppare con tempistiche e procedure ottimizzate un software che sia per il cliente una soluzione di successo. \\La metodologia “Agile” privilegia:
\begin{itemize}
