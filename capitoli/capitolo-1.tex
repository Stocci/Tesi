...
\intro{Questo capitolo illustra l'introduzione al contesto applicativo.}\\
...
\end{figure}
Sanmarco Informatica Spa è un'azienda italiana leader nella progettazione e realizzazione di soluzioni a supporto della riorganizzazione di tutti i processi aziendali e professionali. \\ Ha sede a  Grisignano di Zocco (VI), è attiva da 35 anni e può contare su più di 400 dipendenti e collaboratori per seguire quotidianamente più di 1000 aziende clienti \hyperlink{05}{[5]}. \\ 
Il punto di forza dell'azienda sta nella formazione del personale e nella ricerca continua dell'avanguardia tecnologica, campi nei quali viene investito in media il 20\% del fatturato annuo. \\
...
Un software \emph{ERP, Enterprise Resource Planning}, pianificazione delle risorse d'impresa, è un sistema di gestione che integra tutti i processi di business rilevanti di un'azienda (vendite, acquisti, gestione magazzino, contabilità ecc.).\\Esso si pone l'obiettivo di rendere fluido il passaggio di informazioni tra le varie divisioni di un'azienda, ad esempio allo scopo di ottimizzare la produzione in base alla richiesta effettiva, senza produrre e poi immagazzinare i prodotti.\\
Oltre a JGalileo, Sanmarco Informatica si occupa di svariati prodotti software, tutti potenzialmente interconnessi tra loro e che occupano variegati settori di mercato: dal commercio B2B e B2C, alla Business Intelligence al CRM, quest'ultimo oggetto del mio progetto di stage.\\ 

\subsection{Sede di lavoro}
Sanmarco Informatica, in Italia, può contare su 5 sedi: la sede principale ed il centro Ricerca e Sviluppo si trovano entrambe a Grisignano di Zocco (VI), ci sono poi una filiale a Vimercate (MB), una a Tavagnacco (UD), ed una a Reggio Emilia.\\
La sede del mio stage è stato il centro di Ricerca e Sviluppo.\\
Qui viene adottato il metodo di lavoro \emph{Agile}\hyperlink{06}{[6]}: esso nasce nel 2001 e definisce i dodici principi fondamentali per sviluppare con tempistiche e procedure ottimizzate un software che sia per il cliente una soluzione di successo. \\La metodologia Agile privilegia:
\begin{itemize}
...
StageIT è un'iniziativa che mira ad agevolare l'incontro tra le imprese e gli studenti che entreranno a breve in contatto con il mondo del lavoro, con specifico riferimento al settore \gls{ict}\glsfirstoccur, favorendo un'occasione di conoscenza reciproca mediante colloqui individuali.
\begin{figure}[h]
\centering
\includegraphics[height = 4 cm]{stageit2018}
\caption{Logo di StageIT}
\end{figure}
Gli studenti hanno infatti l' occasione di conoscere svariate realtà, più o meno grandi e recenti, che operano nel settore dell'\gls{ictg} nei più disparati rami applicativi mentre per le aziende, oltre ad essere un'importante vetrina ed un momento di confronto con potenziali partner e concorrenti, costituisce anche la possibilità di conoscere tanti giovani studenti nel corso di un breve arco temporale.\\
...
\hline
\rule[-4mm]{0mm}{1cm}
\textbf{Periodo}  & \textbf{Dal} & \textbf{Al} & \textbf{Descrizione}\\ %TODO provare a rendere mene granulare la tabella
\hline
\rule[-3mm]{0mm}{0.8cm}
...
In particolare, il \textbf{secondo capitolo} enuncia le tecnologie con le quali ho dovuto interfacciarmi durante lo studio del progetto o durante la fase di sviluppo.\\
Il \textbf{terzo capitolo} elenca i requisiti ed i casi d'uso del progetto.\\
Il \textbf{quarto capitolo} descrive lo stato dell'applicazione esistente, con particolare riguardo alla parte di mio interesse.\\
Il \textbf{quinto capitolo} illustra lo sviluppo del protoptipo oggetto del mio progetto, iniziando dallo studio delle tecnologie utilizzate.\\
Nel \textbf{sesto capitolo} sono infine tratte le conclusioni sull'esperienza, dagli obiettivi formativi e produttivi a quelli personali.\\
